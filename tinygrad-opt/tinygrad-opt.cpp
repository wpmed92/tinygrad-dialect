...
int loadAndProcessMLIR(mlir::MLIRContext &context, mlir::OwningOpRef<mlir::ModuleOp> &module) {
  ...
  passManager.addPass(tinygrad::createLowerToAffinePass());
  passManager.addPass(tinygrad::createLowerToLLVMPass());
...
int main(int argc, char **argv) {
  ...
  cl::ParseCommandLineOptions(argc, argv, "TinyGrad compiler\n");
  mlir::MLIRContext context;
  context.getOrLoadDialect<tinygrad::TinyGradDialect>();
